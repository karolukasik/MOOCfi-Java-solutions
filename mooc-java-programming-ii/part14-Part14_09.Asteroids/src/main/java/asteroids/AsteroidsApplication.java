...
public class AsteroidsApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Text pointsCounter = new Text(10, 20, "Points: 0");
        pane.getChildren().add(pointsCounter);
        Button resetButton = new Button("Start again");
        pane.getChildren().add(resetButton);
        resetButton.setTranslateX(WIDTH - 80);
            ...
            public void handle(long now) {
                ...
                projectiles.forEach(projectile -> {
                    ...
                    if (!projectile.isAlive()) {
                        pointsCounter.setText("Points: " + points.addAndGet(1000));
                    }
                });
                ...
                asteroids.removeAll(
                        asteroids.stream().filter(asteroid -> !asteroid.isAlive()).collect(Collectors.toList()));
                ...
                resetButton.setOnMouseClicked(event -> {
                    ...
                    pane.getChildren().addAll(pointsCounter, resetButton);
                    points.set(0);
    ...
    public static void createFirstFiveAsteroids(List<Asteroid> asteroids) {
        for (int i = 0; i < 5; i++) {
