...
public class B_HandTest<_Hand> {
        ...
        public void isConstructor() throws Throwable {
                ...
                assertTrue("Define a public constructor to class " + className + ": public " + className + "()",
                                ctor.isPublic());
        ...
        public void onImplementComparableHand() {
                ...
                try {
                        ...
                        assertTrue("Make sure the class " + className
                                        + " has only one interface, and that that interface is Comparable",
        ...
        private void sanitizingCheck(String klassName, int n, String m) throws SecurityException {
                ...
                for (Field field : fields) {
                        assertFalse("you don't need \"static variables\", in class " + klassName
                                        + ", please remove variable " + field(field.toString(), klassName),
                                        field.toString().contains("static") && !field.toString().contains("final"));
                        assertTrue("all the variables in the class need to be private, in class " + klassName
                                        + " there was a: " + field(field.toString(), klassName),
                ...
                if (fields.length > 1) {
                        ...
                        assertTrue("in class " + klassName + ", you only need " + m + ", please remove any extras",
                                        var <= n);
                }
        }
