...
public class EmployeesTest<_Education, _Person, _Employees> {
    ...
    public void PersonHasCorrectConstructor() throws Throwable {
        ...
        assertEquals("Class Person must have only one constructor, now it has some other number", 1,
                c.getConstructors().length);

        _PersonRef.constructor().taking(String.class, _EducationRef.cls())
    ...
    public void PersonToString() {
        ...
        assertFalse("Make class Person method toString according to the exercise quidelines",
                person.toString().contains("@"));
    ...
    public void PersonnToString2() {
        ...
        for (String[] namesAndEducations : tt) {
            ...
            assertEquals(
                    "h = new Person(\"" + namesAndEducations[0] + "\", Education." + namesAndEducations[1]
                            + "); \nSystem.out.print(h);\n",
    ...
    public void testGetEducation() {
        ...
        assertTrue(errorMessage,
                _PersonRef.method(methodToTest).returning(_EducationRef.cls()).takingNoParams().isPublic());
    }
    ...
    public void getEducationThrowsNoError() throws Throwable {
        ...
        _Education education = _PersonRef.method("getEducation").returning(_EducationRef.cls()).takingNoParams()
                .withNiceError(
    ...
    public void hasMethodAddPerson() throws Throwable {
        ...
        assertTrue(errorMessage,
                _EmployeesRef.method(tt, methodToTest).returningVoid().taking(_PersonRef.cls()).isPublic());
    ...
    public void hasMethodPrintEducation() throws Throwable {
        ...
        _Employees tt = createEmployees();
        assertTrue(errorMessage,
                _EmployeesRef.method(tt, methodToTest).returningVoid().taking(_EducationRef.cls()).isPublic());
        String v = "Error caused by\nEmployees t = new Employees();\nt.print(Education.HS);\n";

        _EmployeesRef.method(tt, methodToTest).returningVoid().taking(_EducationRef.cls()).withNiceError(v)
                .invoke(education("HS"));
    }
